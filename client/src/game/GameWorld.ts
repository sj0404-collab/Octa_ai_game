  ...
  update(delta: number) {
    ...
    if (this.status === "playing") {
      ...
      if (this.input.consumeInteract()) {
        ...
        else if (this.environment.openNearbyDoor(this.player.position)) this.emitSound("door");
      }
